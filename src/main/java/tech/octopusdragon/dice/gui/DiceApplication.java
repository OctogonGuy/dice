...
public class DiceApplication extends Application {
	...
	public void init() {
		...
		dieImages.put(1, new Image(DiceApplication.class.getResourceAsStream(ONE_IMAGE)));
		dieImages.put(2, new Image(DiceApplication.class.getResourceAsStream(TWO_IMAGE)));
		dieImages.put(3, new Image(DiceApplication.class.getResourceAsStream(THREE_IMAGE)));
		dieImages.put(4, new Image(DiceApplication.class.getResourceAsStream(FOUR_IMAGE)));
		dieImages.put(5, new Image(DiceApplication.class.getResourceAsStream(FIVE_IMAGE)));
		dieImages.put(6, new Image(DiceApplication.class.getResourceAsStream(SIX_IMAGE)));
		
		// Initialize the sounds
		diceSound = new MediaPlayer(new Media(DiceApplication.class.getResource(DICE_SOUND).toExternalForm()));
		diceSound.setOnEndOfMedia(() -> {
			diceSound.stop();
		});
		cheerSound = new MediaPlayer(new Media(DiceApplication.class.getResource(CHEER_SOUND).toExternalForm()));
	...
	public void start(Stage primaryStage) {
		...
		root.setBackground(new Background(
				new BackgroundImage(new Image(DiceApplication.class.getResourceAsStream(BACKGROUND_IMAGE)), null, null, null, null)));
